...
// double Flux:: Interpolate                  (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2>,
//                                             int order, int cubic)
// double Flux:: InterpolateCubicCubic        (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2>,
//                                             int i0, int i1, int i2, int j0, int j1, int j2, int order)
// double Flux:: InterpolateQuarticCubic      (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2>,
//                                             int i0, int i1, int i2, int i3, int j0, int j1, int j2, int order)
// double Flux:: InterpolateCubicQuartic      (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2>,
//                                             int i0, int i1, int i2, int j0, int j1, int j2, int j3, int order)
// double Flux:: InterpolateQuarticQuartic    (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2>,
...
double Flux::InterpolateCubicCubic (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX,
				    int i0, int i1, int i2, int j0, int j1, int j2, int order)
{
  double val;
...
double Flux::InterpolateQuarticCubic (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX,
				      int i0, int i1, int i2, int i3, int j0, int j1, int j2, int order)
{
  double val;
...
double Flux::InterpolateCubicQuartic (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX,
				      int i0, int i1, int i2, int j0, int j1, int j2, int j3, int order)
{
  double val;
...
double Flux::InterpolateQuarticQuartic (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX,
					int i0, int i1, int i2, int i3, int j0, int j1, int j2, int j3, int order)
{
  double val;
