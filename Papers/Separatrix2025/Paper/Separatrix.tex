...
B &= - Q_E\,(Q_E+Q_i)-{\rm i}\,(Q_E+Q_i)\,(P_\varphi+P_\perp)\,p^2 + P_\varphi\,P_\perp\,p^4,\\[0.5ex]
...
where 
\begin{align}
B &= - Q_E\,(Q_E+Q_i)-{\rm i}\,(Q_E+Q_i)\,(P_\varphi+P_\perp)\,(n\,|s|)\,\hat{p}^{\,2} + P_\varphi\,P_\perp\,(n\,|s|)^2\,\hat{p}^{\,4}\nonumber\\[0.5ex]
