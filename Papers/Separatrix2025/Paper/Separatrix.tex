...
Let $x$, $y$, $z$ be conventional Cartesian coordinates. Suppose that two current filaments run parallel to the $z$-axis \cite{pom}. Let the first filament carry the
...
\begin{equation}\label{e21}
 n\,(\omega_E+\omega_{\ast\,e})\left[b^{\psi_p} -\frac{B_0}{R_0}\left(\frac{m}{q}-n\right)\xi^{\psi_p}\right] \simeq \frac{B_0}{R_0}\,\frac{m}{q} \,\eta_\parallel \,j_\phi,
\end{equation}
...
\subsection{Introduction}
The aim of this section is analyze  the response of a tokamak plasma possessing a magnetic separatrix to a static RMP of toroidal mode number $n$. 
...
in the immediate vicinity of the separatrix. In fact, the region of overlap extends from ${\mit\Psi}=0.9985$ to $1.0009$. 
...
is the approach taken in existing plasma response codes such as GPEC \cite{ipec,park,gpec,logan}, in which ${\mit\Psi}_c$ is given a value, lying just below unity, that is determined via an empirical guideline.  (This course of action is adopted because GPEC cannot deal with the singularity of the flux coordinate system at ${\mit\Psi}=1$, and
...
\bibitem{mars} Y.Q.~Liu, A.~Bondeson, C.M.~Fransson, B.~Lennartson and C.~Breitzholtz, Phys.\ Plasmas {\bf 7}, 3681 (2000).
...
\bibitem{park} J.-K.~Park and N.C.~Logan, Phys.\ Plasmas {\bf 24}, 032505 (2017).
...
\bibitem{logan} S.~Benjamin, N.C.~Logan and C.~Hansen, Plasma Phys.\ Control.\ Fusion {\bf 67}, 065019 (2025).
