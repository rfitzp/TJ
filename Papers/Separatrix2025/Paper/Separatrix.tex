...
$0<\epsilon_c\ll 1$. The parameter $\epsilon_c$ can be calculated from the edge plasma parameters. It is estimated that $\epsilon_c=1.5\times 10^{-3}$ for an $n=1$
...
harmonic, but multiple  poloidal harmonics, characterized by the set of integer poloidal mode numbers $m$. As is well known, this is the case because, while
...
edge plasma parameters. We find that $\epsilon_c=1.5\times 10^{-3} $ for an $n=1$
RMP,  and $\epsilon_c=4.8\times 10^{-3}$ for an $n=4$ RMP,  in  a typical JET H-mode plasma. 
...
\bibitem{zheng} L.J.~Zheng, M.~Kotschenreuther and P.~Valanju, Phys.\ Plasmas {\bf 24}, 102503 (2017).
