...
\begin{document}
\title{Further Observations on Current Ramp-Up and Ramp-Down in Tokamaks}
...
``Absolute constraints on the magnetic field evolution in tokamak power plants",  that was published on the arXiv.org repository on July 7, 2005.\cite{boozer}.
