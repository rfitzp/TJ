...
The calculation described in this paper has been implemented in the TJ toroidal tearing mode code. \textcolor{blue}{(The basis solutions used to construct
tearing eigenfunctions in TJ can easily be repurposed to construct ideal eigenfunctions.) }
...
IEquations~(\ref{zdef}), (\ref{e58u}), and   (\ref{e70tt}) yield the  axisymmetric ideal-MHD partial differential equations (p.d.e.s),
