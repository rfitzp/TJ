...
to determine the linear two-fluid response of a resonant layer to the perturbation in the outer region. This treatment was extended in Ref.~\cite{rf2022} to take into account the
 ...
 {\em four}\/  coupled  first-order linear o.d.es.  \cite{cole}. It is clearly advantageous to solve the equations in Fourier space. In Refs.~\cite{cole}
 ...
 that converts it into a first-order nonlinear o.d.e.\ \cite{ric1,ric2}. The advantage of the Riccati approach is that it can deal with numerically problematic  solutions
