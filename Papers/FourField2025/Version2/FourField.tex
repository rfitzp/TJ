...
the first Hall-resistive (HRi) response regime of Ref.~\cite{cole}. $\hat{\mit\Delta}_3$ is the response index predicted by the three-field Fourier-space
...
\caption{ The scaled layer response index, $\hat{\mit\Delta}$, plotted as a function of the normalized ${\bf E}\times {\bf B}$ frequency, $Q_E$, in
the second Hall-resistive (HRii) response regime of Ref.~\cite{cole}. See caption to Fig.~\ref{fig1}. }\label{fig2}
\end{figure}
...
\caption{The scaled layer response index, $\hat{\mit\Delta}$, plotted as a function of the normalized ${\bf E}\times {\bf B}$ frequency, $Q_E$, in
the second resistive-inertial (RIii) response regime of Ref.~\cite{cole}. See caption to Fig.~\ref{fig1}.  }\label{fig3}
\end{figure}
...
\caption{ The scaled layer response index, $\hat{\mit\Delta}$, plotted as a function of the normalized ${\bf E}\times {\bf B}$ frequency, $Q_E$, in
the second viscous-resistive (VRii) response regime of Ref.~\cite{cole}. See caption to Fig.~\ref{fig1}. }\label{fig4}
\end{figure}

Figures~\ref{fig1}--\ref{fig4} allow us to assess the consequences of neglecting the term involving $c_\beta^{\,2}$ in Eq.~(\ref{e316}).
...
the neglect of the $c_\beta$ term has a larger relative effect on the real part of the scaled layer response index than on the imaginary part.
Furthermore, Figs.~\ref{fig2} and \ref{fig3} indicate that if the $c_\beta$ term is neglected then the plasma response model fails to capture resonant behavior
that occurs, in some response regimes,  close to the MHD-fluid resonance ($Q_E=0$). All four figures indicate that if the $c_\beta$ term is neglected then the imaginary part
...
clear from the figures, when the $c_\beta$ term is retained then the $Q_E$ value at which ${\rm Im}(\hat{\mit\Delta})=0$ is shifted from the
electron fluid resonace in the ion diamagnetic direction [i.e., ${\rm Im}(\hat{\mit\Delta})=0$ when $Q_E+Q_e<0$] \cite{lee}. 
