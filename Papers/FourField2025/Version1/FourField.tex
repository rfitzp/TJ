...
at various magnetic flux-surfaces within the plasma, in the process forming magnetic island chains that locally flatten the pressure profile and, thereby, degrade the plasma confinement.\cite{wes}
...
$\tau_\perp = r_s^{\,2}/D_\perp$ the energy confinement time.
