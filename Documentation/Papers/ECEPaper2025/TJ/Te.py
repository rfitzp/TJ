...
ReBu = plt.get_cmap ('prism') #plt.get_cmap ('seismic') #= plt.get_cmap ('rainbow')
...
#plt.contour (RR, ZZ, Pr1, levels = 360, colors = 'white', linewidths = 0.2)

cp = plt.contourf (RR, ZZ, Pr1, ncont, cmap = ReBu)

plt.contour (RR, ZZ, rr, rres1, colors = 'black', linewidths = 1.)    
...
plt.contour (RR, ZZ, rr, rres, colors = 'black', linewidths = 1.)    
