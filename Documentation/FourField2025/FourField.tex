...
to determine the two-fluid response of a linear tearing layer to the perturbation in the outer region. This treatment was extended in Ref.~\onlinecite{rf2022} to take into account the
 ...
 In configuration space, the four-field models of Refs.~\onlinecite{cole} and \onlinecite{rf2022} yield a set of resonant layer equations that can be written as 
 ten coupled
 ...
 four first-order linear differential equatons.\cite{cole} It is clearly advantageous to solve the equations in Fourier space. In Refs.~\onlinecite{cole}
