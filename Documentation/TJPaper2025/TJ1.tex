...
\begin{abstract}
A number of improvement to the TJ toroidal tearing mode code are documented. The TJ
code is also successfully benchmarked against the STRIDE toroidal tearing mode code. Finally, the 
...
The eigenfunctions of the various tearing modes in the plasma, which are decoupled by sheared plasma rotation,
are all found to morph into that of the marginally-stable ideal mode   as the boundary is
approached. However, the growth-rates and real frequencies of the various ideal-tearing-modes are different.
...
edge of the plasma is the one that takes off as the boundary is approached. 
...
viscosity,  diamagnetic flows, the ion sound radius,  and perpendicular and parallel energy transport, become important.\cite{ara,hkm,fw,cole,diff}  The resistive layer
...
the $E_{11}$ values calculate by TEAR shows no such increase, because the ideal stability boundary is associated with an $m=3/n=1$ external-kink mode, and this mode does not couple to the $m=2/n=1$ tearing mode in a cylindrical plasma. 
...
plasmas is of order unity, rather than much greater than unity. Thus, the stabilizing effect of average magnetic field-line curvature is a moderate effect in
...
matrix, $\underline{\underline{W}}_{\,p}$,  in the region between the magnetic axis and the plasma boundary, and adding to it the Hermitian vacuum energy matrix,  $\underline{\underline{W}}_{\,v}$,  in order to
...
only reconnected magnetic flux at the $q=2$  (a.k.a.\ the $2/1$ mode) and the $q=3$  (a.k.a.\ the $3/1$ mode)surfaces simultaneously become very unstable as the
...
with the free-boundary  $2/1$ and $3/1$ modes in a  plasma equilibrium that is not close to the ideal stability boundary. It is clear from Fig.~\ref{fig9} that both modes are essentially $m=2$ modes inside the $q=2$ rational surface, $m=3$ modes between
the $q=2$ and $q=3$ rational surfaces, and $m=4$ modes outside the $q=3$ rational surface. Although both modes look fairly similar to
...
Finally, according to the bottom panel of Fig.~\ref{fig11} and Fig.~\ref{fig12}, the marginally-stable ideal mode at the stability boundary is predominately an
$m=4$ mode at the plasma boundary. In other words, the ideal mode is essentially an $m=4/n=1$ external-kink mode, as we would expect from
...
Sect.~\ref{approach}, the elements all tend to infinity as the ideal stability boundary is approached. This implies that the decoupled tearing modes that
only reconnected magnetic flux at the $q=1$ (a.k.a.\ the $1/1$ mode) and the $q=2$ (a.k.a.\ the $2/1$ mode)  surfaces simultaneously become very unstable as the
...
outside the surface.\cite{freidberg,wesson} Note, in particular, that the harmonics of the plasma displacement are all comparatively small at the 
plasma boundary.
...
This new capability allows TJ to accurately identify ideal stability boundaries. The second improvement allows for the presence of
...
a resistive layer model that allows TJ to determine the  growth-rates and rotation frequencies of the various tearing modes to which a
...
non-diffusive in nature, because the mean-free-path between collisions is very much longer than the size of the plasma.\cite{hel,hel1}
...
magnetic flux. We find that the growth-rate of the ideal-tearing-mode whose rational surface lies closest to the edge of the plasma
 is the one that takes off as the stability boundary is approached, even when the boundary is that associated
...
approached, we would eventually expect  a bifurcation in the plasma flow profile to be triggered  by the nonlinear electromagnetic
...
the ideal stability boundary of an internal-kink mode when the wall exactly corresponds to the plasma boundary. This comclusion seems to suggest
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{deltaW.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{Ematrix.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{gamma.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{Unrc1.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=\textwidth]{Psi1.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{Unrc.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{xIdeale.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=\textwidth]{Psi.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{BetaLimit.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{deltaWa.pdf}}
\caption{Variation of the smallest eigenvalue of the free-boundary, $n=1$, total ideal energy matrix, $\delta W$, and the corresponding eigenvalues of the plasma and vacuum energy matrices, 
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{Ematrixa.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{gammaa.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{Unrc1a.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=\textwidth]{Psi1a.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{Unrca.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{xIdealea.pdf}}
\caption{Poloidal harmonics of the perturbed magnetic flux, $\psi(r,\theta)$ (top panel), and the radial plasma displacement, $\xi^r(r,\theta)$,  associated with a free-boundary,
marginally-stable, $n=1$, ideal mode in a 
circular cross-section plasma equilibrium characterized by $q_0=0.8$, $q_a= 2.8$, $p_p=2.0$, 
...
\begin{figure}
\centerline{\includegraphics[width=\textwidth]{Psia.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{BetaLimit1.pdf}}
\caption{Variation of the critical central beta value at marginal ideal stability, $\beta_{0\,{\rm crit}}$, with the relative radius, $b_w$, of the ideal wall surrounding the plasma in 
