...
\left[1- \frac{(n-|m|+1/2)\,(n-|m|+3/2)}{4\,(|m|-1)}\,\frac{1}{z^2}+{\cal O}\left(\frac{1}{z^4}\right)\right],\label{e8nm}\\[0.5ex]
...
\section{Calculation of  Homogeneous Tearing Mode Dispersion Relation}
\subsection{Introduction}
...
\bibitem{connor} J.W.~Connor,  S.C.~Cowley, R.J.~Hastie,  T.C.~Hender,  A.~Hood, and T.J.~Martin, 
