...
Note that there is a factor ${\rm i}^{\,n}$ difference between the definition of the $P_{n-1/2}^{\,n}(z)$ used in this paper and that employed in Ref.~\onlinecite{morse1}.
