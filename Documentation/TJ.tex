...
The calculation of the tearing-mode stability of a high temperature tokamak plasma is most efficiently formulated as  an asymptotic
...
for $j=1,J$ and $k=1,K$. Our general solution is now free of arbitrary coefficients.
 Finally, making use of the definitions of the ${\mit\Pi}_{kj}^a$ and the ${\mit\Pi}_{kk'}^s$ given in Sects.~\ref{axisl} and \ref{smalll}, we obtain the {\em tearing-mode dispersion relation},\cite{connor,cht,am1,pletz}
