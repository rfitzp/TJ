...
Let ${\bf e}$ be the perturbed electric field. It follows that
\begin{equation}
...
which implies that
\begin{align}
r\,R^{\,2}\,e^{\,r}&={\rm i}\,\omega\,\frac{\partial u}{\partial\theta},\\[0.5ex]
r\,R^{\,2}\,e^{\,\theta}&=-{\rm i}\,\omega\,\frac{\partial u}{\partial r},
\end{align}
where $u=u(r,\theta)$. Let 
\begin{equation}
v = |\nabla r|^2\,r\,\frac{\partial u}{\partial r} + r\,\nabla r\cdot\nabla\theta\,\frac{\partial u}{\partial\theta}.
\end{equation}
It follows that
\begin{align}
e_r &={\rm i}\,\omega\left[\frac{1}{r\,|\nabla r|^2\,R^{\,2}}\,\frac{\partial u}{\partial \theta} + \frac{\nabla r\cdot\nabla\theta}{|\nabla r|^2}\,v\right],\\[0.5ex]
e_\theta &= -{\rm i}\,\omega\,v.
\end{align}
Hence, Eq.~(\ref{e81op}) gives
\begin{equation}
r^2\,\alpha_g\,y = r\,\frac{\partial v}{\partial r}+\frac{\partial}{\partial\theta}\!\left[\frac{1}{|\nabla r|^2\,R^{\,2}}\,\frac{\partial u}{\partial \theta}+ \frac{r\,\nabla r\cdot\nabla\theta}{|\nabla r|^2}\,v\right].
\end{equation}
Finally, in the vacuum region, in which $\alpha_g=0$, we have $u=v=0$. 

\subsection{Electromagnetic Energy Flux}
The net electromagnetic energy flux out of the plasma is
\begin{align}
...
&={\rm i}\,2\,\pi\,\omega\left(\oint\left [\alpha_g\,(v\,y^\ast- v^\ast\,y) + (y\,z^\ast-y^\ast\,z)\right]\right)_{r=a},\nonumber\\[0.5ex]
&={\rm i}\,\pi^2\,\omega \sum_{m}\left(z_m^\ast\,y_m-y_m^\ast\,z_m\right)_{r=a}.
\end{align}
Here, use has been made of the fact that $v=0$ for $r\geq a$. 
...
\end{align}
where $s=\hat{r}\,q'/q$, 
\begin{align}{\mit\Sigma} &=\frac{1}{q}\left(\frac{3\,\hat{r}^{\,2}}{2} -2\,\hat{r}\,H_1'+S_2\right) - \frac{2-s}{q}\left(-\frac{3\,\hat{r}^{\,2}}{4}+\frac{\hat{r}^{\,2}}{q^2} +H_1+S_1\right),\\[0.5ex]
