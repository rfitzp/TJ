...
\end{equation}
[Note that the perturbed magnetic field component $Z(r,\theta)$ should not be confused with the Cartesian coordinate of the same name.]
...
r\,\frac{\partial Z}{\partial r}&= -\left[(\alpha_f\,\alpha_p+ r\,\alpha_p')R^{\,2} + q\,r\,\alpha_g'+r^2\,\alpha_g^{\,2}\right]y-\frac{\partial}{\partial\theta}\!\left(\frac{1}{|\nabla r|^2\,R^{\,2}}\,\frac{\partial y}{\partial\theta}\right)\nonumber\\[0.5ex]
...
&={\rm i}\,\pi\,\omega\oint (y\,Z^{\,\ast}-y^\ast \,Z)_{r=a}\,d\theta,\nonumber\\[0.5ex]
...
\begin{equation}
 ...
 is Hermitian. It immediately follows from Eq.~(\ref{e39x}) that ${\cal E}=0$. In other words, there is zero net electromagnetic energy flux out of  a plasma
