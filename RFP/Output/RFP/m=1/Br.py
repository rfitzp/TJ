...
plt.xlabel(r'$(\phi-\phi_1)/\pi$', fontsize="20")
...
plt.xlim (-1., 1.)
plt.ylim (-1.1, 1.1)
plt.plot(phi, cr0(phi), color = 'red', linewidth = 2, linestyle = 'solid', label=r"$\beta_0=0.00$")
plt.plot(phi, cr1(phi), color = 'green', linewidth = 2, linestyle = 'solid', label=r"$\beta_0=0.01$")
plt.plot(phi, cr2(phi), color = 'blue', linewidth = 2, linestyle = 'solid', label=r"$\beta_0=0.02$")
plt.plot(phi, cr3(phi), color = 'yellow', linewidth = 2, linestyle = 'solid', label=r"$\beta_0=0.03$")
plt.plot(phi, cr4(phi), color = 'cyan', linewidth = 2, linestyle = 'solid', label=r"$\beta_0=0.04$")
plt.plot(phi, cr5(phi), color = 'black', linewidth = 2, linestyle = 'solid', label=r"$\beta_0=0.045$")
plt.axhline(y=0., color = 'black', linestyle = 'dotted', linewidth = '1.')
plt.axvline(x=0., color = 'black', linestyle = 'dotted', linewidth = '1.')
