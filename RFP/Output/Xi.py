...
plt.plot(xrr, xi1, color='blue', linewidth = 2, linestyle = 'solid')
...
plt.xlabel(r'$\hat{r}$', fontsize="20")
plt.ylabel(r"$\hat{\xi}_1$",  fontsize="20")
...
plt.plot(xrr, xi2, color='blue', linewidth = 2, linestyle = 'solid')
...
plt.xlabel(r'$\hat{r}$', fontsize="20")
plt.ylabel(r"$\hat{\xi}_2$",  fontsize="20")
...
plt.plot(xrr, xi3, color='blue', linewidth = 2, linestyle = 'solid')
...
plt.xlabel(r'$\hat{r}$', fontsize="20")
plt.ylabel(r"$\hat{\xi}_3$",  fontsize="20")
