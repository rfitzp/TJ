...
plt.plot (r, Psi_r[14,0,:], color = 'black',   linewidth = 2, linestyle = 'dashdot', label = r'$m=4$')
...
plt.plot (r, Psi_r[14,1,:], color = 'black',   linewidth = 2, linestyle = 'dashdot', label = r'$m=4$')
