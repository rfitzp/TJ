...
plt.plot (r[1:], Xi_r[11,j,1:], color = 'black', linewidth = 2.0, linestyle = 'dashed', label = r"$m=2$")
plt.plot (r[1:], Xi_r[12,j,1:], color = 'black', linewidth = 2.0, linestyle = 'dashed', label = r"$m=3$")
