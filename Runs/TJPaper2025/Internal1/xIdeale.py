...
plt.ylabel (r"$\psi_m$", fontsize = "15", labelpad = -7)
...
plt.plot (r[2:], Xi_r[11,j,2:], color = 'black',   linewidth = 1.5, linestyle = 'solid', label = '$m=1$')
plt.plot (r,     Xi_r[12,j,:],  color = 'red',     linewidth = 1.5, linestyle = 'solid', label = '$m=2$')
plt.plot (r,     Xi_r[13,j,:],  color = 'green',   linewidth = 1.5, linestyle = 'solid', label = '$m=3$')
plt.plot (r,     Xi_r[14,j,:],  color = 'blue',    linewidth = 1.5, linestyle = 'solid', label = '$m=4$')
plt.plot (r,     Xi_r[15,j,:],  color = 'cyan',    linewidth = 1.5, linestyle = 'solid', label = '$m=5$')
