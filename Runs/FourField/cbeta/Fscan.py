...
plt.plot (gi, dr100, color = 'red',   linewidth = 2, linestyle = 'solid', label = r"$c_\beta=1.0$")
...
plt.plot (gi, di100, color = 'red',   linewidth = 2, linestyle = 'solid', label = r"$c_\beta=1.0$")
