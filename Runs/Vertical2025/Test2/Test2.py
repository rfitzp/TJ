...
plt.plot (df.iloc[:,0], df.iloc[:,4], color = 'blue',  linewidth = 1,   linestyle = 'dotted', marker = 's', fillstyle = 'none', markersize = 10, label = r'$\alpha_{w}(5)$')
plt.plot (df.iloc[:,0], df.iloc[:,9], color = 'red',   linewidth = 1,   linestyle = 'dotted', marker = '^', fillstyle = 'none', markersize = 10, label = r'$\alpha_{w}(10)$')
#plt.axhline (0.,                      color = 'black', linewidth = 1.5, linestyle = 'dotted')
plt.axvline (0.,                      color = 'black', linewidth = 1.5, linestyle = 'dotted')
...
plt.plot (df.iloc[:,0], df.iloc[:,5],  color = 'blue',  linewidth = 1,   linestyle = 'dotted', marker = 's', fillstyle = 'none', markersize = 10, label = r'$\hat{\gamma}_{w}(5)$')
plt.plot (df.iloc[:,0], df.iloc[:,10], color = 'red',   linewidth = 1,   linestyle = 'dotted', marker = '^', fillstyle = 'none', markersize = 10, label = r'$\hat{\gamma}_{w}(10)$')
plt.axhline (0.,                       color = 'black', linewidth = 1.5, linestyle = 'dotted')
plt.axvline (0.,                      color = 'black', linewidth = 1.5, linestyle = 'dotted')
