...
// Intermediate plotting data in Outputs/Stage1.nc
// Intermediate data in Outputs/Stage1/
// Final plotting data in Outputs/Stage2.nc
// Final data in Outputs/Stage2/
...
extern "C" void NameListRead (int* NPSI, double* PACK, int* NTHETA, double* H0, double* ACC);
...
private:
  ...
  double InterpolateCubicCubic     (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX, int i0, int i1, int i2, int j0, int j1, int j2,                 int order);
  double InterpolateQuarticCubic   (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX, int i0, int i1, int i2, int i3, int j0, int j1, int j2,         int order);
  double InterpolateCubicQuartic   (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX, int i0, int i1, int i2, int j0, int j1, int j2, int j3,         int order);
  double InterpolateQuarticQuartic (double RR, double ZZ, int NRpts, int NZpts, double* Rpts, double* Zpts, Array<double,2> XX, int i0, int i1, int i2, int i3, int j0, int j1, int j2, int j3, int order);
