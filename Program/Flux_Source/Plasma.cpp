...
void Flux::Stage2ReadData ()
{
  ...
  // Read Psiaxis
  // ............
  file = OpenFiler ((char*) "Outputs/Stage1/PsiAxis.txt");
  if (fscanf (file, "%lf", &Psic) != 1)
    {
      printf ("FLUX::Stage2ReadData: Error reading Outputs/Stage1/PsiAxis.txt\n");
      exit (1);
    }
  fclose (file);
...
void Flux::Stage2CalcQ ()
{
  ...
  qa = QP[NPSI-1];
  ra = rP[NPSI-1];
  printf ("qa = %9.2e  ra = %9.2e  a = %9.2e (m)\n",
	  qa, ra, ra*R0);
}
...
void Flux::Stage2CalcStraightAngle ()
{
  ...
  // ..........................................
  // Calculate straight angle coordinate system
  // ..........................................
