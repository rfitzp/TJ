...
// ################################################################
double TJ::ToroidalP (int m, int n, double z)
{
  // Check argument
  if (z < 1.)
    {
      printf ("TJ::ToroidalP: Error - z < 1.\n");
      exit (1);
    }	
...
//
// #############################################################
double TJ::ToroidaldPdz (int m, int n, double z)
{
...
// ##############################################################
double TJ::GetCoshMu (double R, double Z)
{
...
// ##########################################
double TJ::GetEta (double R, double Z)
{
  double r2 = R*R + Z*Z;
