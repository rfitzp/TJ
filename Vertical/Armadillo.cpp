...
// #################################################################################################################
void Vertical::SolveLinearSystem (Array<double,2> A, Array<double,2> X, Array<double,2> B)
{
  ...
  if (size1 != size2)
    {
      printf ("Vertical::SolveLinearSystem: Error - over/underdetermined linear system\n");
      exit (1);
    }
...
// #################################################################################################################
void Vertical::SolveLinearSystemTranspose (Array<double,2> A, Array<double,2> X, Array<double,2> B)
{
  ...
  if (size1 != size2)
    {
      printf ("Vertical::SolveLinearSystemTranspose: Error - over/underdetermined linear system\n");
      exit (1);
    }
...
// ####################################################################################################################
void Vertical::SolveLinearSystem (Array<complex<double>,2> A, Array<complex<double>,2> X, Array<complex<double>,2> B)
{
  int size1 = A.extent(0);
  int size2 = A.extent(1);
  int size3 = B.extent(1);
...
// ####################################################################################################################
void Vertical::SolveLinearSystemTranspose (Array<complex<double>,2> A, Array<complex<double>,2> X, Array<complex<double>,2> B)
{
  int size1 = A.extent(1);
  int size2 = A.extent(0);
  int size3 = B.extent(0);
...
// are complex vectors
// ###################################################################################################################
void Vertical::SolveLinearSystem (Array<complex<double>,2> A, complex<double>* X, complex<double>* B)
{
  int size1 = A.extent(0);
  int size2 = A.extent(1);
...
// ########################################
void Vertical::InvertMatrix (Array<complex<double>,2> A, Array<complex<double>,2> invA)
{
  int size = A.extent(0);
...
// ####################################################################
void Vertical::GetEigenvalues (Array<complex<double>,2> H, double* evals, Array<complex<double>,2> evecs)
{
  int size = H.extent(0);
...
// ###################################################
void Vertical::GetEigenvalues (Array<complex<double>,2> H, double* evals)
{
  int size = H.extent(0);
...
// ##################################################################
void Vertical::SquareRootMatrix (Array<complex<double>,2> A, Array<complex<double>,2> sqrtA)
{
  int size = A.extent(0);
...
// ##########################################################################
void Vertical::InvSquareRootMatrix (Array<complex<double>,2> A, Array<complex<double>,2> invsqrtA)
{
  int size = A.extent(0);
