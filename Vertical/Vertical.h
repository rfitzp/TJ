...
class Vertical : private Utility
{
 private:
  ...
  int      K;    // Number of included poloidal harmonics, excluding m=0
  int      jm0;  // Index of m=0 harmonic
  ...
  int*     MPOX; // Poloidal mode numbers of included poloidal harmonics, excluding m=0
  double*  mpox; // Poloidal mode numbers of included poloidal harmonics, excluding m=0
  int*     jrnd; // Reindexing array
