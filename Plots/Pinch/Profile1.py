...
plt.plot    (r, btc, color = 'black', linewidth = 2,   linestyle = 'solid',  label = r'$\hat{B}_\varphi$')
plt.plot    (r, bpc, color = 'black', linewidth = 2,   linestyle = 'dashed', label = r'$\hat{B}_\theta$')
