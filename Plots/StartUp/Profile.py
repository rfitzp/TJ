...
plt.plot    (x, T, color = 'blue',  linewidth = 2,  linestyle = 'solid')
plt.axhline (0.,   color = 'black', linewidth = 1., linestyle = 'dotted')

plt.xlabel (r'$x$',            fontsize = font)
plt.ylabel (r'$\overline{T}$', fontsize = font)

plt.subplot (3, 1, 2)

plt.xlim (0., 1.)
 
plt.plot    (x, j, color = 'blue',  linewidth = 2, linestyle = 'solid')
plt.axhline (0.,   color = 'black', linewidth = 1, linestyle = 'dotted')

plt.xlabel (r'$x$',            fontsize = font)
plt.ylabel (r'$\overline{j}$', fontsize = font)
...
plt.axhline (3.,   color = 'black', linewidth = 1, linestyle = 'dotted')
