...
# Plots kth poloidal harmonic of psi, Z, and Xi components of m-dominant ideal solution launched from magnetic axis versus r.
# User prompted for m and poloidal harmomic mode number.
