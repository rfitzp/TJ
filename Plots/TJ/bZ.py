...
# Plots b^Z component of unreconnected eigenfunction associated with given rational surface in R, Z plane.
...
fig.canvas.manager.set_window_title (r'TJ Code: b^Z(R, Z)')
