...
# Plots delta n_e component of unreconnected eigenfunction associated with given rational surface in R, Z plane.
...
fig.canvas.manager.set_window_title (r'TJ Code: delta n_e(R, Z)')
...
print ("delta n_e_cos = (%10.3e, %10.3e)" % (prmin, prmax))
print ("delta n_e_sin = (%10.3e, %10.3e)" % (pimin, pimax))
