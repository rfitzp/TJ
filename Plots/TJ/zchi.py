...
# Plots z, chi components of unreconnected eigenfunction associated with given rational surface in R, Z plane.
...
ds1   = nc.Dataset(fn1)
rres  = ds1['r_res']
psi_r = ds1['z_unrc_eig_r']
psi_i = ds1['z_unrc_eig_i']
z_r   = ds1['chi_unrc_eig_r']
z_i   = ds1['chi_unrc_eig_i']

fig = plt.figure (figsize = (8.5, 8.0))
fig.canvas.manager.set_window_title (r'TJ Code: z(R, Z), chi(R, Z)')
