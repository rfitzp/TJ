...
# Plots second derivatives of tearing eigenfunction versus radius in vicinity of rational surface
...
ds  = nc.Dataset(fn)
r   = np.asarray(ds['r'])
psi = np.asarray(ds['psi_pp'])
psr = np.asarray(ds['psi_ppr'])
rs  = ds['rres']
sg  = ds['sigma']
...
fig.canvas.manager.set_window_title (r'RegularTear Code: Second Derivative of Tearing Eigenfunction')
