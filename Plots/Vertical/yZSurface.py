...
# Plots y and Z on plasma boundary associated with ideal eigenfunction.
...
fig.canvas.manager.set_window_title (r'Vertical Code: Ideal Eigenfunction Boundary Data: deltaW = %10.3e %10.3e %10.3e' % (w[j], p[j], v[j]))
