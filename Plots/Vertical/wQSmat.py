...
# Visualizes wall matrix (Q^dag S)_m^m'
# Also shows anti-Hermitian component of (wQ^dag wS)_m^m'
...
fig.canvas.manager.set_window_title (r'Vertical Code: Wall Matrix QS = Q^dag S')
