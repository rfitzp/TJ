...
# Visualizes vacuum matrix (P^dag R)_m^m'
# Also shows anti-Hermitian component of (P^dag R)_m^m'
...
fig.canvas.manager.set_window_title (r'Vertical Code: Vacuum Matrix PR = P^dag R')
