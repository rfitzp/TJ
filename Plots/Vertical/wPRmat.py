...
# Visualizes wall matrix (P^dag R)_m^m'
# Also shows anti-Hermitian component of (wP^dag wR)_m^m'
...
fig.canvas.manager.set_window_title (r'Vertical Code: Wall Matrix PR = P^dag R')
