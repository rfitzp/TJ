...
# Plots optical depths of 1st harmonic O-mode and 2nd harmonic X-mode
...
fig.canvas.manager.set_window_title (r'TJ Code: ECE Optical Depths')
...
plt.ylabel (r'$\hat{\tau}_{1}^{\,(O)}$', fontsize = font)
...
plt.xlabel (r'$\omega_c/\omega_p$',      fontsize = font)
plt.ylabel (r'$\hat{\tau}_{2}^{\,(X)}$', fontsize = font)
