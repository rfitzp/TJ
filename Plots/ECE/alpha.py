...
# Plots absorption coefficients of 1st harmonic O-mode and 2nd harmonic X-mode
...
plt.ylabel (r'$\hat{\alpha}_{1}^{\,(O)}$', fontsize = font)
...
plt.xlabel (r'$\omega_c/\omega_p$',        fontsize = font)
plt.ylabel (r'$\hat{\alpha}_{2}^{\,(X)}$', fontsize = font)
