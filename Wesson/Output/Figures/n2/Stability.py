...
plt.title(r"$m=3, n=2~~~\bar{b}=10$", fontsize = 15)
...
plt.ylabel(r'$\nu$',   fontsize="20")
plt.xlabel(r'$q_a$',   fontsize='20')
plt.title(r"$m=3, n=2~~~\bar{b}=1.1$", fontsize = 15)
#plt.legend(fontsize="20")
...
plt.ylabel(r'$\nu$',   fontsize="20")
plt.xlabel(r'$q_a$',   fontsize='20')
plt.title(r"$m=4, n=2~~~\bar{b}=10$", fontsize = 15)
#plt.legend(fontsize="20")
...
plt.ylabel(r'$\nu$',   fontsize="20")
plt.xlabel(r'$q_a$',   fontsize='20')
plt.title(r"$m=4, n=2~~~\bar{b}=1.1$", fontsize = 15)
#plt.legend(fontsize="20")
