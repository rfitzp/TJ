...
fig.canvas.manager.set_window_title (r'H_2=1.0: V_2=0.1: q_0=1.1: epsilon_a=0.3: p_0=0.1')
...
plt.plot (qa, e12r, color = 'blue',  linewidth = 1, linestyle = 'dotted', marker = 's', fillstyle = 'none', markersize = 5, label = 'TJ')
plt.plot (qa, e21r, color = 'blue',  linewidth = 1, linestyle = 'dotted', marker = 'x', fillstyle = 'none', markersize = 5)
plt.plot (qa, E12r, color = 'green', linewidth = 1, linestyle = 'dotted', marker = 's', fillstyle = 'none', markersize = 5, label = 'STRIDE')
...
plt.plot (qa, E21i, color = 'green', linewidth = 1, linestyle = 'dotted', marker = 'x', fillstyle = 'none', markersize = 5)
